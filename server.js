    ...
    function (req, res) {
        ...
        if (!monitoringPhrase) {
            ...
            var monitoringResponse = "<HEAD>" +
                ...
                "<BODY>\n" +
                "<P>\n" +
                "El twitterverso se esta sintiendo: <br>\n" +
                "<IMG align=\"middle\" src=\"" + sentimentImage() + "\"/><br>\n" +
                "sobre <h3>" + monitoringPhrase + ".</h3><br><br>" +
                "Analizando " + tweetCount + " tweets...<br>" +
                "</P>\n" +
                "<A href=\"/reset\">Usar otra palabra</A>\n" +
                "</BODY>";
